...
public:
  Publish(std::string const &publisher, std::vector<std::string> controlDependencies={}) : SymbolicRosApiCall(), publisher(publisher), controlDependencies(controlDependencies) {}
